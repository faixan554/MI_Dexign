    ...
    <header className="text-white bg-black body-font border-b-2 border-b-gray-600">
      <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-lg md:text-xl font-sans font-semibold justify-center list-none">
          <li className="mr-5 cursor-pointer text-blue-600 hover:text-blue-700"><Link rel="noreferrer" href="/">HOME</Link></li>
          <li className="mr-5 cursor-pointer hover:text-blue-700"><Link rel="noreferrer" href="/about">ABOUT ME</Link></li>
          <li className="mr-5 cursor-pointer hover:text-blue-700"><Link rel="noreferrer" href="/contact">CONTACT</Link></li>
        </nav>
      </div>
    </header>
  )
