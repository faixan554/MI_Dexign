    ...
    <footer class="text-white bg-black body-font border-t-2 border-gray-600">
      <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 space-x-3 justify-center sm:justify-start md:mr-10">
          <a href='https://www.facebook.com/profile.php?id=100087282346637' target='_blank' class="text-xl text-gray-200 hover:text-red-600 cursor-pointer">
            Facebook
          </a>
          <a href="https://www.instagram.com/mi_dexign/" target='_blank' class="text-xl ml-3 text-gray-200 hover:text-red-600 cursor-pointer">
            Instagram
          </a>
          <a href='https://www.uplabs.com/midexign' target='_blank' class="text-xl ml-3 text-gray-200 hover:text-red-600 cursor-pointer">
            Uplabs
          </a>
        </span>
      </div>
